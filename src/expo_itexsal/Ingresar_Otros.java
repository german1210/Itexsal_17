 ...
 * @author ger
 */
public class Ingresar_Otros extends javax.swing.JFrame {
    ...
    try {
        cn=MySQL.Conectar();
        String sql="INSERT INTO otros (nombre,descripcion,talla,color,disponible,imagen) "
    ...
    /**
     * Creates new form Ingresar_Otros
     */
    public Ingresar_Otros() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingresar_Otros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ingresar_Otros().setVisible(true);
            }
        });
    }
