 ...
 * @author ger
 */
public class Ingresar_Camisetas extends javax.swing.JFrame {
    
    Connection cn;
    Statement enviado;
    
    void Insertar(String nombre, String descripcion, String talla, String color, String disponible, String imagen){
    try {
        cn=MySQL.Conectar();
        String sql="INSERT INTO camisetas (nombre,descripcion,talla,color,disponible,imagen) "
                + "VALUES ('"+nombre+"','"+descripcion+"','"+talla+"','"+color+"','"+disponible+"','"+imagen+"')";
    ...
    /**
     * Creates new form Ingresar_Camisetas
     */
    public Ingresar_Camisetas() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(txtNombre.getText().length()>0 && txtDescripcion.getText().length()>0
            ...
            Insertar(txtNombre.getText(), txtDescripcion.getText(), (String) txtTalla.getSelectedItem(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingresar_Camisetas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ingresar_Camisetas().setVisible(true);
            }
        });
    }
