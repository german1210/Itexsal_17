 ...
 * @author ger
 */
public class Ingresar_Shorts extends javax.swing.JFrame {
    ...
    try {
        cn=MySQL.Conectar();
        String sql="INSERT INTO shorts (nombre,descripcion,talla,color,disponible,imagen) "
    ...
    /**
     * Creates new form Ingresar_Shorts
     */
    public Ingresar_Shorts() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingresar_Shorts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ingresar_Shorts().setVisible(true);
            }
        });
    }
