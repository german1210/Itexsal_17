 ...
 * @author ger
 */
public class Ingresar_Pants extends javax.swing.JFrame {
    ...
    try {
        cn=MySQL.Conectar();
        String sql="INSERT INTO pants (nombre,descripcion,talla,color,disponible,imagen) "
    ...
    /**
     * Creates new form Ingresar_Pants
     */
    public Ingresar_Pants() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingresar_Pants.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ingresar_Pants().setVisible(true);
            }
        });
    }
